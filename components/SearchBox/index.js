...
const Index = connectSearchBox(({ currentRefinement, refine }) => (
  <form
    noValidate
    className="bg-white rounded py-2 px-3 h-12 flex items-center shadow"
    role="search">
    <button type="submit" className="leading-none text-grey" title="Submit your search query">
      <svg width="18" height="18" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" className="fill-current inline">
    ...
    <input
      ...
      autoComplete="off"
      autoCorrect="off"
      className="bg-white flex-1 p-2 mx-1 text-black leading-tight"
      name="search"
