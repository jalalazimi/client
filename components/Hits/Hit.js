    ...
    {css && (
      <a
        ...
        <CompatibilityIcon label="Includes CSS files (click for details)">
          <polygon
            points="3.53 2 2.959 5 14.575 5 14.213 7 2.589 7 2.026 10.139 13.642 10.139 13 12 8 13.5 4.533 12 1.679 12 1 14.12 7.5 17 15.447 14.12 18 2"/>
        </CompatibilityIcon>
      </a>
    )}
  </div>
  ...
  <div className="ml-3 float-right">
    ...
    {homepage && (
      <a
        ...
        target="_blank"
        rel="noopener noreferrer">
        <svg xmlns="http://www.w3.org/2000/svg" className="inline" width="16" height="13" viewBox="0 0 16 13">
          <polygon
            points="6.118 13 6.118 8.412 9.176 8.412 9.176 13 13 13 13 6.882 15.294 6.882 7.647 0 0 6.882 2.294 6.882 2.294 13"/>
        </svg>
      </a>
    )}
    <div className="inline-block relative">
      ...
      <Dropdown>
        <DropdownTrigger className="btn btn-primary p-2 border-l border-indigo-800 rounded-l-none">
          <svg
            className="inline"
            width="13"
            height="13"
        ...
        <DropdownContent className="dropdown-content right-0 left-0 mt-1">
...
const Hit = ({hit, location, expanded}) => {
  const popular =
  ...
  return (
    <div
      className={
        expanded
          ? "relative bg-white px-8 py-6 text-black container mx-auto border-b border-grey"
