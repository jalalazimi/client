    ...
    <div className="relative bg-white px-4 py-6">
      ...
      <h4 className="mb-3 font-bold text-sm uppercase text-gray-600 ">
        ...
        {hit.collections.length > 0 && (
          <>
            {hit.communityPick && <span className="bg-green-100 text-green-900 rounded-full ml-4 px-3 py-1">Community pick</span>}
            {!hit.communityPick && popular &&
            <span className="bg-orange-100 text-orange-900 rounded-full px-3 py-1 ml-4 font-bold text-center">Popular</span>}
            {!hit.communityPick &&
            !popular &&
            outdated && <span className="bg-gray-200 text-gray-900 rounded-full px-3 py-1 ml-4 font-bold text-center">Outdated</span>}
          </>
        )}
      </h4>
      <div>
