    ...
    <ul className="flex">
      <li className="mr-6">
        <a
          ...
          className="no-underline text-black text-blue-500 hover:text-blue-800">
          Submit a package
        </a>
      </li>
      <li className="mr-6">
        <a href="http://blog.js.coach/" className="no-underline text-black px-3 text-blue-500 hover:text-blue-800">
          Blog
        </a>
      </li>
      <li className="mr-6">
        <a href="mailto:hello@js.coach"
           className="no-underline text-black inline-block">
      ...
      <li className="mr-6">
        <a href="https://twitter.com/_jscoach" className="no-underline text-black inline-block">
          <svg viewBox="0 0 16 16" width="16" height="16" xmlns="http://www.w3.org/2000/svg" className="inline">
            <path
